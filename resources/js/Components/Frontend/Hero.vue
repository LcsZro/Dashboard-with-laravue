        ...
        <div class="container mx-auto h-full">
            <div class="flex items-center h-full pt-8">
                <div class="flex-1 flex flex-col items-center lg:items-start">
                    ...
                    <h1 class="text-4xl leading-[44px] md:text-5xl md:leading-tight lg:text-7xl lg:leading-[1.2] font-bold md:tracking-[-2px] text-[#2F2E41] dark:text-white">
                        I'm a web developer
                    </h1>
                    <p class="pt-4 pb-8 md:pt-6 max-w-[480px] dark:text-slate-400 text-lg text-center lg:text-left">
                    ...
                    <button class="py-4 px-5 font-medium text[#3F3D56] dark:text-white flex items-center justify-center rounded-lg hover:text-slate-700 hover:bg-[#68b42dc2] bg-[#68B42D] transition-all lg:h-[55px] md:h-[48px]">
                        Work With me
                    </button>
                </div>
